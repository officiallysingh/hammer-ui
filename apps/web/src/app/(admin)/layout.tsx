...
import { Users, ShieldCheck, KeyRound, LogOut, Gavel, Menu, ChevronRight } from 'lucide-react';
...
const SidebarContent = ({ pathname, onClose, user, handleSignOut }: SidebarContentProps) => (
  <>
    {/* Brand */}
    ...
    <nav className="flex-1 py-4 px-3 space-y-1 overflow-y-auto">
      <p className="px-3 mb-2 font-body text-[10px] font-semibold text-muted-foreground uppercase tracking-widest">
        Management
      </p>
    ...
    <div className="border-t border-border p-4 shrink-0">
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="font-body text-sm font-medium text-foreground truncate">{user.username}</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-body text-xs text-muted-foreground hidden sm:block">
                {activeLink?.description ?? 'Dashboard'}
              </p>
            </div>
          </div>
          <Link
